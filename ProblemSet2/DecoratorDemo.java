public class DecoratorDemo {
	public static void main(String[] args){
		MyPizza woofPizza = new Ham (new TomatoSauce(new Cheese(new PlainPizza())));
		System.out.println("Ingredients: " + woofPizza.ingredients());
		System.out.println("Price: " + woofPizza.getCost());
